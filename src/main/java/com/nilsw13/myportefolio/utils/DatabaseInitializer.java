...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public DatabaseInitializer(ProjectRepository projectRepository, EntityManager entityManager) {
    ...
    private void waitForDatabase() {
        ...
        while (!tablesCreated && attempt < maxAttempts) {
            try {
                ...
                entityManager.createNativeQuery("SELECT 1 FROM projects LIMIT 1").getResultList();
                tablesCreated = true;
